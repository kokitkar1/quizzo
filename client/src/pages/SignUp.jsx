  ...
  return (
    <div className='p-3 max-w-lg mx-auto left-part'>
      ...
      <form onSubmit={handleSubmit} className='flex flex-col gap-4'>
        ...
        <button disabled={loading} className=' bg-pink-900 text-white p-3 rounded-full uppercase hover:opacity-80 disabled:opacity-80'> {loading? 'Loading...' : 'Sign Up'} </button>
        <span className=' text-center p-4'>Or login with</span>
        <OAuth />
      </form>
