...
const Profile = () => {
  ...
  const handleSignOut = async () => {
    try {
      ...
      dispatch(signOutUserFailure(error.message));// TODO: need to remind there is error.message instead of data.message
    }
  }
  ...
  return (
    <div className=' p-3 max-w-lg mx-auto'>
      ...
      <div className=' flex justify-between mt-5'>
        <span onClick={handleDeleteUser} className=' text-red-700 cursor-pointer'></span>
